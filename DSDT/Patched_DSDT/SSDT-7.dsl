 ...
 *
 * Disassembly of iASLwwp2sQ.aml, Sat Apr  1 16:46:11 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003982 (14722)
 *     Revision         0x02
 *     Checksum         0xFD
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.PEG0._ADR, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.PEGP.TGPC, BuffObj)    // (from opcode)
    ...
    OperationRegion (SANV, SystemMemory, 0x37FF8D98, 0x0138)
