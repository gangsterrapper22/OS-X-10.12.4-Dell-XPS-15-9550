 ...
 *
 * Disassembly of iASLQmoBQj.aml, Sat Apr  1 17:03:57 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000049BA (18874)
 *     Revision         0x02
 *     Checksum         0x4C
 *     OEM ID           "DptfTa"
...
DefinitionBlock ("", "SSDT", 2, "DptfTa", "DptfTabl", 0x00001000)
{
    ...
    External (DDDR, FieldUnitObj)    // (from opcode)
    ...
    External (G1AT, FieldUnitObj)    // (from opcode)
    External (G1C3, FieldUnitObj)    // (from opcode)
    External (G1CT, FieldUnitObj)    // (from opcode)
    External (G1HT, FieldUnitObj)    // (from opcode)
    External (G1PT, FieldUnitObj)    // (from opcode)
    External (G2AT, FieldUnitObj)    // (from opcode)
    External (G2C3, FieldUnitObj)    // (from opcode)
    External (G2CT, FieldUnitObj)    // (from opcode)
    External (G2HT, FieldUnitObj)    // (from opcode)
    External (G2PT, FieldUnitObj)    // (from opcode)
    ...
    External (S1AT, FieldUnitObj)    // (from opcode)
    External (S1CT, FieldUnitObj)    // (from opcode)
    External (S1DE, FieldUnitObj)    // (from opcode)
    External (S1HT, FieldUnitObj)    // (from opcode)
    External (S1PT, FieldUnitObj)    // (from opcode)
    External (S1S3, FieldUnitObj)    // (from opcode)
    External (S2AT, FieldUnitObj)    // (from opcode)
    External (S2CT, FieldUnitObj)    // (from opcode)
    External (S2DE, FieldUnitObj)    // (from opcode)
    External (S2HT, FieldUnitObj)    // (from opcode)
    External (S2PT, FieldUnitObj)    // (from opcode)
    External (S2S3, FieldUnitObj)    // (from opcode)
    External (S3AT, FieldUnitObj)    // (from opcode)
    External (S3CT, FieldUnitObj)    // (from opcode)
    External (S3DE, FieldUnitObj)    // (from opcode)
    External (S3HT, FieldUnitObj)    // (from opcode)
    External (S3PT, FieldUnitObj)    // (from opcode)
    External (S3S3, FieldUnitObj)    // (from opcode)
    External (S4AT, FieldUnitObj)    // (from opcode)
    External (S4CT, FieldUnitObj)    // (from opcode)
    External (S4DE, FieldUnitObj)    // (from opcode)
    External (S4HT, FieldUnitObj)    // (from opcode)
    External (S4PT, FieldUnitObj)    // (from opcode)
    External (S4S3, FieldUnitObj)    // (from opcode)
    ...
    External (SSP1, FieldUnitObj)    // (from opcode)
    External (SSP2, FieldUnitObj)    // (from opcode)
    External (SSP3, FieldUnitObj)    // (from opcode)
    External (SSP4, FieldUnitObj)    // (from opcode)
