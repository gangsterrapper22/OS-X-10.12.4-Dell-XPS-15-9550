 ...
 *
 * Disassembly of iASLSOLzHf.aml, Sat Apr  1 16:42:56 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000332B (13099)
 *     Revision         0x02
 *     Checksum         0xA0
 *     OEM ID           "INTEL "
...
DefinitionBlock ("", "SSDT", 2, "INTEL ", "PtidDevc", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.B1MH, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.B1ML, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.LPCB.H_EC.BKAP, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.LPCB.H_EC.ECAV, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.LPCB.H_EC.PMDT, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PPDT, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PPWR, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRC0, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRC1, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRCL, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRCM, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRCS, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRFC, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PRIN, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.LPCB.H_EC.PSTE, UnknownObj)    // (from opcode)
